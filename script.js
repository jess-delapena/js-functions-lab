...
function generateEmail(){
    console.log('johnsmith'+'example.com')
}
...
function convertTempToCelsius(celsius){
    ...
    var result = celsiusToFahr = "C";
    console.log(result);
}
function convertTempToFahr(Fahrenheit){
    var fahrTemp = Fahrenheit;
    var fahrToCelsius = (fahrTemp - 32) * 5/9;
    var resuly = fahrToCelsius = "F";
    console.log(result);
}
convertTempToCelsius(32)
